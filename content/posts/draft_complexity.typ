== What is average complexity anyways
...
// - big-O vs big-Omega vs small-o vs small-Omega
// - inclusion/exclusion rules
// - examples for inverse, negative complexities
// - alternative definition of complexity (not knuth)
...
// - talk about semirings
// - taking limits of complexities
//   (like m->\infty O(n/m) = O(1))
//   (it's a limit of set)
//   (there's multiple notions of "convergence in measure")
//
// - tommy: O(f(n, m)) = O(n O(g(m))) through limit def?
// "composition of big O"
// nvm he was not cooking
//
// complexity of algorithms
// - timestemp function
// - model of computation
// - taking max, min timestemp fn
// - forall/exists variants of big omega
// - message complexity
//
// average complexity
// - different distributions
// - what would mode, median complexity be
// - percentile complexity
// - make a histogram of timestemps for a given algo
